...
## 🧭 קצת עליי  
מפתחת תוכנה עם ניסיון בפיתוח מערכות Web ופתרונות SaaS, בעלת חשיבה אנליטית, יוזמה ויכולת למידה עצמית גבוהה.  
עובדת בסביבות פיתוח מבוססות **React, Angular, C#, Node.js, PostgreSQL, Docker** ו־AWS.  
שואפת לפתח מוצרים יעילים, נגישים וחדשניים שמשפיעים על המשתמשים באמת.
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Rachel-wertheimer&show_icons=true&theme=radical&hide_border=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=Rachel-wertheimer&layout=compact&theme=radical&hide_border=true)
